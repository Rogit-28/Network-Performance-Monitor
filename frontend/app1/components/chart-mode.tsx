...
export default function ChartMode() {
  const { chartData, availableInterfaces, selectedInterfaces, setSelectedInterfaces, loading, error } = useMetrics()
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
        <div>
          <h2 className="text-2xl font-semibold mb-1">Network Metrics</h2>
          <p className="text-sm text-muted-foreground">Interactive visualization of real-time network performance</p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6">
        <Card className="p-6 border border-border bg-card/50">
          <h3 className="text-sm font-semibold mb-4">Latency & Jitter Trend</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="p-6 border-border bg-card/50">
          <h3 className="text-sm font-semibold mb-4">Throughput Analysis</h3>
        ...
        <Card className="p-6 border border-border bg-card/50">
          <h3 className="text-sm font-semibold mb-4">Bandwidth Usage</h3>
          <ResponsiveContainer width="100%" height={300}>
      ...
      {/* Packet Loss */}
      <Card className="p-6 border-border bg-card/50">
        <h3 className="text-sm font-semibold mb-4">Packet Loss Rate</h3>
